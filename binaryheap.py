...
class BinaryHeap(object) :
    ...
    class takes do_max input
        do_max == 1 : if it is a max_heap
        do_max == 0 : if it is a min_heap
    ...
    def push(self, value):
        ...
        return self._max_traverse_push(tmp_index, value) if self._do_max else self._min_traverse_push(tmp_index, value)
    def pop(self) :
        ...
        return self._max_traverse_pop(height, 0) if self._do_max else self._min_traverse_pop(height, 0)
